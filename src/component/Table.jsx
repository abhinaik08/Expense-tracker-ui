        ...
        <TableBody>
          ...
          :allExpenses.map((row, index) => (
            ...
            >
              ...
              <TableCell><Button component={Link} to={`/edit/${row._id}`} sx={{ ml:1,color:"black",backgroundColor:"green"}} variant='contained'>Edit</Button>
              <Button onClick={()=>handleDelete(row?._id)} sx={{ ml:1,color:"black",backgroundColor:"red"}} variant='contained'>Delete</Button></TableCell>
            </TableRow>
          ))}
        </TableBody>
      </Table>
